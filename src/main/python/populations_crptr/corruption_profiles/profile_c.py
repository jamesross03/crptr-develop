...
# 24/6/2015
#
# A config object implemention of the corruption profile 'C', as defined in Tom
# Daltons thesis (see 7.4)
...
class CorrutionProfileC {
    # 0 for Standard human transcription, 1 for OCR
    TYPE = 0
